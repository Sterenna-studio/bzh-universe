# Aligax — dossier personnage

## Statut
- Personnage coeur de BZH Chronicles.
- Alias TCG : `The Iron Maiden`.
- Alias musical associe : `Digital Maiden`.
...
## Points a consolider
- Clarifier la part canonique entre Aligax guerriere autonome et variante d'armure fusionnee.
- Rattacher les visuels definitifs quand ils seront importes.
